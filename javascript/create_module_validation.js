...
var name = document.create_module.create_module_name;
var  s_time= document.create_module.start_time;
var  d_time= document.create_module.submit_time;
var  description= document.create_module.create_module_description;
...
{
alert('Module Name must have alphabet characters only');
name.focus();
return false;
}
}
