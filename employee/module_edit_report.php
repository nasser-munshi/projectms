...
if(empty($_FILES["submit_module_file"]["name"]))
{
    
    mysqli_query($con,"UPDATE module SET module_status='successful', module_submitted_date='$s_date', module_submitted_description='$_POST[submit_module_description]'
