...
$select= mysqli_query($con,"SELECT * FROM employee Where employee_username='$_SESSION[username]'");
			...
			<!-- content starts -->
				...
				<div class="box span12">
					...
					<div class="box-content">
						<form name="edit_employee_profile" class="form-horizontal" method="post" action="edit_employee_profile.php" onsubmit="return formValidation()" enctype="multipart/form-data">
						  <fieldset>
