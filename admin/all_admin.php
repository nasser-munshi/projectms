			...
			<!-- content starts -->
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-list-alt"></i> Admin </h2>
					</div>
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
                                                      ...
                                                      while($select_F = mysqli_fetch_array($select))
                                                        {
                                                          echo "<tr>";
                                                          echo "<td>".$select_F['admin_username']."</td>";
									  ...
									  <form  action='admin_view.php' method='post'>
                                                                                 <input type='hidden' name='a_view' value='". $select_F['admin_username']."'  >  
                                                          ...
                                                          echo "
									<div class='btn-e'>
									  <form  action='admin_edit_form.php' method='post'>
                                                                                 <input type='hidden' name='a_edit' value='". $select_F['admin_username']."'  >
									  ...
									  <form  action='a_delete.php' method='post'>
                                                                                 <input type='hidden' name='a_del' value='". $select_F['admin_username']."'  > 
