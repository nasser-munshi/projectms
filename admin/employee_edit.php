...
if(empty($_FILES["e_uploadimage"]["name"]))
{
    ...
    mysqli_query($con,"UPDATE employee SET full_name='$_POST[e_edit_fullname]', post='$_POST[e_edit_post]', email='$_POST[employee_email]', gender='$_POST[u_gender]',birth_date='$birth_date_e',contact_no='$_POST[employee_contact_no]', current_address='$_POST[employee_current_address]'
WHERE employee_username= '$_POST[e_username]'");
}
...
$file= ($_FILES["e_uploadimage"]["name"]);
 ...
 mysqli_query($con,"UPDATE employee SET full_name='$_POST[e_edit_fullname]', post='$_POST[e_edit_post]', email='$_POST[employee_email]', gender='$_POST[u_gender]',birth_date='$birth_date_e',contact_no='$_POST[employee_contact_no]', image ='$file', current_address='$_POST[employee_current_address]' 
WHERE employee_username= '$_POST[e_username]'");
