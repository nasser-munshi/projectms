...
if(empty($_FILES["e_uploadimage"]["name"]))
{
    ...
    mysqli_query($con,"UPDATE admin SET email='$_POST[admin_email]', gender='$_POST[u_gender]',birth_date='$birth_date_e',contact_no='$_POST[admin_contact_no]', current_address='$_POST[admin_current_address]'
...
$file= ($_FILES["e_uploadimage"]["name"]);
 ...
 mysqli_query($con,"UPDATE admin SET email='$_POST[admin_email]', gender='$_POST[u_gender]',birth_date='$birth_date_e',contact_no='$_POST[admin_contact_no]', image ='$file', current_address='$_POST[admin_current_address]' 
WHERE admin_username= '$_SESSION[username]'");
